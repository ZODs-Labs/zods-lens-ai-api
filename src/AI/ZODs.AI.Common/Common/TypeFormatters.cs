...
internal class TypeFormatters
{
    ...
    public static string ToString(DateTime value, string format) => value.Kind switch
    {
        ...
        _ => throw new NotSupportedException($"DateTime {value} has a Kind of {value.Kind}.You can call DateTime.SpecifyKind to change Kind property value to DateTimeKind.Utc.")
    };
