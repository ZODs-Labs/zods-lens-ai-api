...
namespace ZODs.Api.Repository.Migrations
{
    ...
    [Migration("20231213231356_Update_RequestLog_Metadata_Nullability")]
    partial class Update_RequestLog_Metadata_Nullability
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ZODs.Api.Repository.Entities.AI.UserAICreditBalance", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<int>("Gpt3Credits")
                        .HasColumnType("integer");

                    b.Property<int>("Gpt4Credits")
                        .HasColumnType("integer");
                    ...
                    b.ToTable("UserAICreditBalances");
                });

            modelBuilder.Entity("ZODs.Api.Repository.Entities.Entities.AILens", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");

                    b.Property<string>("BehaviorInstruction")
                        .IsRequired()
                        .HasMaxLength(1000)
                    ...
                    b.Property<string>("ResponseInstruction")
                        .IsRequired()
                        .HasMaxLength(1000)
                        .HasColumnType("character varying(1000)");
            ...
            modelBuilder.Entity("ZODs.Api.Repository.Entities.Entities.Subscription", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("ZODs.Api.Repository.Entities.RequestLog", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("ZODs.Api.Repository.Entities.UserAILensSettings", b =>
                {
                    b.Property<Guid>("UserId")
                        .HasColumnType("uuid");

                    b.Property<Guid>("AILensId")
                        .HasColumnType("uuid");
                    ...
                    b.HasKey("UserId", "AILensId");

                    b.HasIndex("AILensId");

                    b.ToTable("UserAILensSettings");
                });
            ...
            modelBuilder.Entity("ZODs.Api.Repository.Entities.WorkspaceSnippetsVersion", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<int>("SnippetsVersion")
                        .HasColumnType("integer");
                    ...
                    b.ToTable("WorkspaceSnippetsVersions");
                });
            ...
            modelBuilder.Entity("ZODs.Api.Repository.Entities.AI.UserAICreditBalance", b =>
                {
                    b.HasOne("ZODs.Api.Repository.Entities.User", "User")
                        .WithOne("UserAICreditBalance")
                        .HasForeignKey("ZODs.Api.Repository.Entities.AI.UserAICreditBalance", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("ZODs.Api.Repository.Entities.UserAILensSettings", b =>
                {
                    b.HasOne("ZODs.Api.Repository.Entities.Entities.AILens", "AILens")
                        .WithMany()
                        .HasForeignKey("AILensId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ZODs.Api.Repository.Entities.User", "User")
                        .WithMany("UserAILensSettings")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("ZODs.Api.Repository.Entities.WorkspaceMemberInvite", b =>
                {
                    b.HasOne("ZODs.Api.Repository.Entities.User", "AcceptedByUser")
                        .WithMany()
            ...
            modelBuilder.Entity("ZODs.Api.Repository.Entities.User", b =>
                {
                    ...
                    b.Navigation("UserAICreditBalance")
                        .IsRequired();

                    b.Navigation("UserAILensSettings");
